            ...
            <div>
              ...
              <form @submit.prevent="handleSubmit">
                <div class="space-y-5">
                  <div>
                    <label
                      for="usernameOrEmail" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400 font-sans"
                    >
                      Username atau Email<span class="text-red-500">*</span>
                    </label>
                    <input
                      v-model="usernameOrEmail"
                      type="text" id="usernameOrEmail" name="usernameOrEmail" placeholder="Masukkan username atau email Anda"
                  ...
                  <div>
                    ...
                    <div class="relative">
                      <input
                        ...
                        class="dark:bg-gray-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-4 pr-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-emerald-300 focus:outline-none focus:ring-3 focus:ring-emerald-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-emerald-800 font-sans"
                      />
                      <span
                  ...
                  <div class="flex items-center justify-between">
                    <div>
                      <label
                        for="keepLoggedIn"
                        class="flex items-center text-sm font-normal text-gray-700 cursor-pointer select-none dark:text-gray-400 font-sans"
                      >
                        <div class="relative">
                          <input
...
// Mengubah 'email' menjadi 'usernameOrEmail'
...
const handleSubmit = async () => {
  ...
  if (!trimmedInput || !password.value) {
    alert('Mohon masukkan username/email dan password Anda.');
    return;
  }
  ...
  if (success) {
    ...
    alert('Login gagal: ' + (userStore.error || 'Terjadi kesalahan tidak dikenal.'));
  }
};
</script>
